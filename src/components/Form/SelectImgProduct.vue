...
<template>
    ...
    <label class="form-label">Selecione uma imagem para o produto </label>

    <Field name="image" class="d-none"  v-slot="{ handleChange, value }">
    ...
    <!-- Modal -->
    <Teleport to="body">
        <div ref="modalElement" class="modal fade selectImgModal" id="selectImgModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="selectImgModal">Cortar imagem</h1>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" @click="modal.hide()" data-bs-target="#selectImgModal">Cancelar</button>
